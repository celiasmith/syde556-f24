...
\begin{frame}{Organization (I)}
	...
	\begin{block}{Course website}
		\begin{itemize}
			\item LEARN
			\item \url{https://github.com/celiasmith/syde556-f22}
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}{Schedule}
	\begin{block}{Syllabus, Project Template, Due Dates}
    \begin{itemize}
      \item These are available at \url{http://compneuro.uwaterloo.ca/courses/syde-750.html}
      \item Assignments, slides, and lecture notes are posted on github
    \end{itemize}
    \end{block}
\end{frame}
